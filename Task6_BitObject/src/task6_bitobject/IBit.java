...
public interface IBit {
     ...
     */
    public abstract boolean checkBit(int n) throws Exception;
     ...
     * или выходит за границы массива.
     */
    public abstract boolean turnOnBit(int n) throws Exception;
     ...
     * или выходит за границы массива.
     */
    public abstract boolean turnOffBit(int n) throws Exception;
     ...
     * или выходит за границы массива.
     */
    public abstract boolean invertBit(int n) throws Exception;

    public abstract void turnAllBitsOn();

    public abstract void turnAllBitsOff();
}